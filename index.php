...
function show_count_tasks(array $tasks, $project) {
    $sum = 0;
                        ...
                        <?php foreach ($projects as $project): ?>
                            <?php if (isset($project)): ?>
                                <li class="main-navigation__list-item">
                                    ...
                                    <span class="main-navigation__list-item-count"><?= show_count_tasks($tasks, $project) ?></span>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>
            ...
            <main class="content__main">
                ...
                <table class="tasks">
                    <?php foreach ($tasks as $key => $task): ?>
                        <?php if (isset($task)): ?>
                            <?php if ($show_complete_tasks == 0 && $task["finish"]): continue; ?>
                            <?php endif; ?>
                            <tr class="tasks__item task <?php if ($task['finish']): ?>task--completed<?php endif; ?>">
                                <td class="task__select">
                                    <label class="checkbox task__checkbox">
                                        <input class="checkbox__input visually-hidden task__checkbox" type="checkbox" value="1" <?php if ($task['finish']): ?>checked<?php endif; ?>>
